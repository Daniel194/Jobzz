angular.module('jobzz')
    .controller('JobDetailsEmployeeCtrl', ['$scope', '$rootScope', '$mdPanel', 'jobService', 'employerProfileService', '$location',
        'userProfilePictureService',
        function ($scope, $rootScope, $mdPanel, jobService, employerProfileService, $location, userProfilePictureService) {
